            ...
            <div class="container">
                <div class="row service-header">
                    ...
                    <div class="col-8">
                        <ul class="nav nav-pills justify-content-end">
                            <li class="nav-item"><a class="nav-link" href="#">Frequent Questions</a></li>
                ...
                <!-- <div class="row text-center mt-4">
                    ...
                    <div class="col-md-8">
                        ...
                        <p class="text-center">Order.UK simplifies the food ordering process. Browse through our diverse
                            menu, select your favorite dishes, and proceed to checkout. Your delicious meal will be on
                            its
                ...
                <div class="row">
                    ...
                    <div class="col-9">
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="v-pills-link3" role="tabpanel"
                                aria-labelledby="v-pills-link3-tab">
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                                Aspernatur, illum.
                            </div>
                            <div class="tab-pane fade" id="v-pills-link4" role="tabpanel"
